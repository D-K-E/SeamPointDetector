...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.pushButton_2 = QtWidgets.QPushButton(self.tableTool)
        ...
        self.pushButton_3 = QtWidgets.QPushButton(self.tableTool)
        ...
        self.pointRegionLabel = QtWidgets.QLabel(self.pointEditorTool)
        self.pointRegionLabel.setObjectName("pointRegionLabel")
        self.verticalLayout_11.addWidget(self.pointRegionLabel)
        self.pointRegionComboBox = QtWidgets.QComboBox(self.pointEditorTool)
        self.pointRegionComboBox.setObjectName("pointRegionComboBox")
        self.verticalLayout_11.addWidget(self.pointRegionComboBox)
        ...
        self.regionTable = QtWidgets.QTableWidget(self.regionEditorTool)
        self.regionTable.setObjectName("regionTable")
        self.regionTable.setColumnCount(0)
        self.regionTable.setRowCount(0)
        self.verticalLayout_13.addWidget(self.regionTable)
        self.horizontalLayout_4 = QtWidgets.QHBoxLayout()
        self.horizontalLayout_4.setObjectName("horizontalLayout_4")
        self.verticalLayout_14 = QtWidgets.QVBoxLayout()
        self.verticalLayout_14.setObjectName("verticalLayout_14")
        self.regionColorLabel = QtWidgets.QLabel(self.regionEditorTool)
        self.regionColorLabel.setObjectName("regionColorLabel")
        self.verticalLayout_14.addWidget(self.regionColorLabel)
        self.regionColorComboBox = QtWidgets.QComboBox(self.regionEditorTool)
        self.regionColorComboBox.setObjectName("regionColorComboBox")
        self.verticalLayout_14.addWidget(self.regionColorComboBox)
        self.horizontalLayout_4.addLayout(self.verticalLayout_14)
        self.verticalLayout_16 = QtWidgets.QVBoxLayout()
        self.verticalLayout_16.setObjectName("verticalLayout_16")
        self.addRegionBtn = QtWidgets.QPushButton(self.regionEditorTool)
        self.addRegionBtn.setObjectName("addRegionBtn")
        self.verticalLayout_16.addWidget(self.addRegionBtn)
        self.removeRegionBtn = QtWidgets.QPushButton(self.regionEditorTool)
        self.removeRegionBtn.setObjectName("removeRegionBtn")
        self.verticalLayout_16.addWidget(self.removeRegionBtn)
        ...
        self.resetRegionSelectionBtn = QtWidgets.QPushButton(self.regionEditorTool)
        self.resetRegionSelectionBtn.setObjectName("resetRegionSelectionBtn")
        self.horizontalLayout_2.addWidget(self.resetRegionSelectionBtn)
        self.verticalLayout_13.addLayout(self.horizontalLayout_2)
        self.toolBox.addItem(self.regionEditorTool, "")
        ...
        self.markRegionRBtn = QtWidgets.QRadioButton(self.carveGroup)
        self.markRegionRBtn.setObjectName("markRegionRBtn")
        self.horizontalLayout.addWidget(self.markRegionRBtn)
        self.markPointRBtn = QtWidgets.QRadioButton(self.carveGroup)
        self.markPointRBtn.setObjectName("markPointRBtn")
        self.horizontalLayout.addWidget(self.markPointRBtn)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.pushButton_2.setText(_translate("MainWindow", "Add Region File"))
        ...
        self.pushButton_3.setText(_translate("MainWindow", "Open Region File"))
        ...
        self.pointRegionLabel.setText(_translate("MainWindow", "Point Region"))
        ...
        self.regionColorLabel.setText(_translate("MainWindow", "Region Color"))
        self.addRegionBtn.setText(_translate("MainWindow", "Save Regions"))
        self.removeRegionBtn.setText(_translate("MainWindow", "Remove Region"))
        self.resetRegionSelectionBtn.setText(_translate("MainWindow", "Reset Selection"))
        self.toolBox.setItemText(self.toolBox.indexOf(self.regionEditorTool), _translate("MainWindow", "Region Editor"))
        self.markRegionRBtn.setText(_translate("MainWindow", "Mark Region"))
        self.markPointRBtn.setText(_translate("MainWindow", "Mark Point"))
